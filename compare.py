...
def initialize():
    ...
    SOURCE_FILE = 'data/conc.wav' # args.source_file if args.source_file else None
    TARGET_FILE = 'data/jingle/jingle.wav' # args.target_file if args.target_file else None
